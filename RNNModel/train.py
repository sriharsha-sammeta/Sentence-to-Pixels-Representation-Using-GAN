...
parser.add_argument('--penal_type', type=str, default='pairwise_kl', help='type of penalization: frobenius|pairwise_kl|...')
...
if not args.pretrained:
    model = SelfAttentive( ntokens, args.emsize, args.nhid, args.nlayers, args.da, args.r, args.mlp_nhid, nclass, emb_matrix, args.cuda, args.penal_type)
else:
